...
\begin{verbatim}
## Warning: `cols` is now required.
## Please use `cols = c(power, power_sim, ess, ess_sim)`
\end{verbatim}
...
## 2 group-sequential <GrpSqntD> <adptrOpR>  115.  110.      110.
## 3 two-stage        <TwStgDsg> <adptrOpR>  113.  114.      114.
\end{verbatim}
...
\begin{verbatim}
## Warning: `cols` is now required.
## Please use `cols = c(toer_sim, power_sim)`
\end{verbatim}
