...
As in \protect\hyperlink{variantI.2}{Variant I.2} another initial design is more appropriate
...
As in \protect\hyperlink{variantII.1}{Variant II.1}, expected sample size under the full prior
is minimized.
...
Due to the additional constraint in comparison to \protect\hyperlink{variantII.1}{Variant II.1},
...
\includegraphics{adoptr-validation-report_files/figure-latex/unnamed-chunk-112-1.pdf}
