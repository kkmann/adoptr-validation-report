...
\NormalTok{testthat}\OperatorTok{::}\KeywordTok{expect_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(cp_sim_val }\OperatorTok{>=}\StringTok{ }\NormalTok{(}\FloatTok{0.7}\NormalTok{) }\OperatorTok{*}\StringTok{ }\FloatTok{0.99}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{adoptr-validation-report_files/figure-latex/unnamed-chunk-35-1.pdf}
...
\includegraphics{adoptr-validation-report_files/figure-latex/unnamed-chunk-58-1.pdf}
...
\includegraphics{adoptr-validation-report_files/figure-latex/unnamed-chunk-70-1.pdf}
...
\includegraphics{adoptr-validation-report_files/figure-latex/unnamed-chunk-103-1.pdf}
...
\includegraphics{adoptr-validation-report_files/figure-latex/unnamed-chunk-120-1.pdf}
...
\includegraphics{adoptr-validation-report_files/figure-latex/unnamed-chunk-125-1.pdf}
...
\includegraphics{adoptr-validation-report_files/figure-latex/unnamed-chunk-130-1.pdf}
