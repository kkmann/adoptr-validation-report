...
\includegraphics{adoptr-validation-report_files/figure-latex/unnamed-chunk-34-1.pdf}

\hypertarget{scenario-ii-1}{%
\chapter{Scenario II}\label{scenario-ii-1}}
...
\hypertarget{case-ii-1-minimizing-expected-sample-size-under-point-prior}{%
\section{Case II-1: Minimizing Expected Sample Size under Point Prior}\label{case-ii-1-minimizing-expected-sample-size-under-point-prior}}
...
\hypertarget{case-ii-2-minimizing-expected-sample-size-under-null-hypothesis}{%
\section{Case II-2: Minimizing Expected Sample Size under Null Hypothesis}\label{case-ii-2-minimizing-expected-sample-size-under-null-hypothesis}}
...
\hypertarget{case-ii-3-conditional-power-constraint}{%
\section{Case II-3: Conditional Power Constraint}\label{case-ii-3-conditional-power-constraint}}
...
\includegraphics{adoptr-validation-report_files/figure-latex/unnamed-chunk-57-1.pdf}

\hypertarget{scenario-iii-large-effect-uniform-prior-alternative}{%
\chapter{Scenario III: large effect, uniform prior alternative}\label{scenario-iii-large-effect-uniform-prior-alternative}}
...
\hypertarget{case-iii.1-convergence-under-prior-concentration}{%
\section{Case III.1: Convergence under prior concentration}\label{case-iii.1-convergence-under-prior-concentration}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sim_toer <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(design) \{}
\NormalTok{    simdata <-}\StringTok{ }\KeywordTok{simulate}\NormalTok{(}
\NormalTok{        design,}
        \DataTypeTok{nsim  =} \DecValTok{10}\OperatorTok{^}\DecValTok{6}\NormalTok{, }
        \DataTypeTok{dist  =}\NormalTok{ datadist, }
        \DataTypeTok{theta =}   \FloatTok{.0}\NormalTok{,}
        \DataTypeTok{seed  =} \DecValTok{42}
\NormalTok{    )}
    \KeywordTok{return}\NormalTok{(}\KeywordTok{list}\NormalTok{(}
        \DataTypeTok{toer =} \KeywordTok{mean}\NormalTok{(simdata}\OperatorTok{$}\NormalTok{reject), }
        \DataTypeTok{se   =} \KeywordTok{sd}\NormalTok{(simdata}\OperatorTok{$}\NormalTok{reject) }\OperatorTok{/}\StringTok{ }\KeywordTok{sqrt}\NormalTok{(}\KeywordTok{nrow}\NormalTok{(simdata))}
\NormalTok{    ))}
\NormalTok{\}}

\NormalTok{tmp     <-}\StringTok{ }\KeywordTok{sapply}\NormalTok{(results, }\ControlFlowTok{function}\NormalTok{(x) }\KeywordTok{sim_toer}\NormalTok{(x}\OperatorTok{$}\NormalTok{design))}
\NormalTok{df_toer <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}
    \DataTypeTok{toer =} \KeywordTok{as.numeric}\NormalTok{(tmp[}\DecValTok{1}\NormalTok{, ]),}
    \DataTypeTok{se   =} \KeywordTok{as.numeric}\NormalTok{(tmp[}\DecValTok{2}\NormalTok{, ])}
\NormalTok{)}
...
\NormalTok{testthat}\OperatorTok{::}\KeywordTok{expect_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(df_toer}\OperatorTok{$}\NormalTok{toer }\OperatorTok{<}\StringTok{ }\FloatTok{.025}\NormalTok{))}
...
\includegraphics{adoptr-validation-report_files/figure-latex/unnamed-chunk-68-1.pdf}

\hypertarget{scenario-iv-smaller-effect-point-alternative}{%
\chapter{Scenario IV: smaller effect, point alternative}\label{scenario-iv-smaller-effect-point-alternative}}
...
\hypertarget{case-iv-1-minimizing-expected-sample-size-under-point-prior}{%
\section{Case IV-1: Minimizing Expected Sample Size under Point Prior}\label{case-iv-1-minimizing-expected-sample-size-under-point-prior}}
...
\begin{Highlighting}[]
\NormalTok{testthat}\OperatorTok{::}\KeywordTok{expect_equal}\NormalTok{(}
    \KeywordTok{sim_n}\NormalTok{(opt1_os}\OperatorTok{$}\NormalTok{design, }\FloatTok{.2}\NormalTok{, datadist),}
    \KeywordTok{evaluate}\NormalTok{(ess, opt1_os}\OperatorTok{$}\NormalTok{design),}
    \DataTypeTok{tolerance =} \FloatTok{.5}
\NormalTok{)}

\NormalTok{testthat}\OperatorTok{::}\KeywordTok{expect_equal}\NormalTok{(}
    \KeywordTok{sim_n}\NormalTok{(opt1_gs}\OperatorTok{$}\NormalTok{design, }\FloatTok{.2}\NormalTok{, datadist),}
    \KeywordTok{evaluate}\NormalTok{(ess, opt1_gs}\OperatorTok{$}\NormalTok{design),}
    \DataTypeTok{tolerance =} \FloatTok{.5}
\NormalTok{)}

\NormalTok{testthat}\OperatorTok{::}\KeywordTok{expect_equal}\NormalTok{(}
    \KeywordTok{sim_n}\NormalTok{(opt1_ts}\OperatorTok{$}\NormalTok{design, }\FloatTok{.2}\NormalTok{, datadist),}
    \KeywordTok{evaluate}\NormalTok{(ess, opt1_ts}\OperatorTok{$}\NormalTok{design),}
    \DataTypeTok{tolerance =} \FloatTok{.5}
\NormalTok{)}
\end{Highlighting}
...
\hypertarget{case-iv-2-increase-power}{%
\section{Case IV-2: Increase Power}\label{case-iv-2-increase-power}}
...
\NormalTok{testthat}\OperatorTok{::}\KeywordTok{expect_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(df_pow}\OperatorTok{$}\NormalTok{pow }\OperatorTok{>=}\StringTok{ }\FloatTok{.9} \OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{-}\StringTok{ }\FloatTok{0.02}\NormalTok{)))}
...
\NormalTok{testthat}\OperatorTok{::}\KeywordTok{expect_equal}\NormalTok{(}
    \KeywordTok{sim_n}\NormalTok{(opt2_os}\OperatorTok{$}\NormalTok{design, }\FloatTok{.0}\NormalTok{, datadist),}
    \KeywordTok{evaluate}\NormalTok{(ess_}\DecValTok{0}\NormalTok{, opt2_os}\OperatorTok{$}\NormalTok{design),}
    \DataTypeTok{tolerance =} \FloatTok{.5}
\NormalTok{)}

\NormalTok{testthat}\OperatorTok{::}\KeywordTok{expect_equal}\NormalTok{(}
    \KeywordTok{sim_n}\NormalTok{(opt2_gs}\OperatorTok{$}\NormalTok{design, }\FloatTok{.0}\NormalTok{, datadist),}
...
\begin{Highlighting}[]
\NormalTok{testthat}\OperatorTok{::}\KeywordTok{expect_equal}\NormalTok{(}
    \KeywordTok{sim_n}\NormalTok{(opt2_os}\OperatorTok{$}\NormalTok{design, }\FloatTok{.2}\NormalTok{, datadist),}
    \KeywordTok{evaluate}\NormalTok{(ess, opt2_os}\OperatorTok{$}\NormalTok{design),}
    \DataTypeTok{tolerance =} \FloatTok{.5}
\NormalTok{)}

\NormalTok{testthat}\OperatorTok{::}\KeywordTok{expect_equal}\NormalTok{(}
    \KeywordTok{sim_n}\NormalTok{(opt2_gs}\OperatorTok{$}\NormalTok{design, }\FloatTok{.2}\NormalTok{, datadist),}
    \KeywordTok{evaluate}\NormalTok{(ess, opt2_gs}\OperatorTok{$}\NormalTok{design),}
    \DataTypeTok{tolerance =} \FloatTok{.5}
\NormalTok{)}

\NormalTok{testthat}\OperatorTok{::}\KeywordTok{expect_equal}\NormalTok{(}
    \KeywordTok{sim_n}\NormalTok{(opt2_ts}\OperatorTok{$}\NormalTok{design, }\FloatTok{.2}\NormalTok{, datadist),}
    \KeywordTok{evaluate}\NormalTok{(ess, opt2_ts}\OperatorTok{$}\NormalTok{design),}
    \DataTypeTok{tolerance =} \FloatTok{.5}
\NormalTok{)}
\end{Highlighting}
...
\hypertarget{case-iv-3-increase-type-one-error-rate}{%
\section{Case IV-3: Increase Type One Error rate}\label{case-iv-3-increase-type-one-error-rate}}
...
\NormalTok{testthat}\OperatorTok{::}\KeywordTok{expect_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(df_toer}\OperatorTok{$}\NormalTok{toer }\OperatorTok{<=}\StringTok{ }\FloatTok{.055}\OperatorTok{*}\NormalTok{(}\FloatTok{1.02}\NormalTok{)))}
...
\NormalTok{testthat}\OperatorTok{::}\KeywordTok{expect_equal}\NormalTok{(}
    \KeywordTok{sim_n}\NormalTok{(opt3_os}\OperatorTok{$}\NormalTok{design, }\FloatTok{.0}\NormalTok{, datadist),}
    \KeywordTok{evaluate}\NormalTok{(ess_}\DecValTok{0}\NormalTok{, opt3_os}\OperatorTok{$}\NormalTok{design),}
    \DataTypeTok{tolerance =} \FloatTok{.5}
\NormalTok{)}

\NormalTok{testthat}\OperatorTok{::}\KeywordTok{expect_equal}\NormalTok{(}
    \KeywordTok{sim_n}\NormalTok{(opt3_gs}\OperatorTok{$}\NormalTok{design, }\FloatTok{.0}\NormalTok{, datadist),}
    \KeywordTok{evaluate}\NormalTok{(ess_}\DecValTok{0}\NormalTok{, opt3_gs}\OperatorTok{$}\NormalTok{design),}
    \DataTypeTok{tolerance =} \FloatTok{.5}
\NormalTok{)}

\NormalTok{testthat}\OperatorTok{::}\KeywordTok{expect_equal}\NormalTok{(}
    \KeywordTok{sim_n}\NormalTok{(opt3_ts}\OperatorTok{$}\NormalTok{design, }\FloatTok{.0}\NormalTok{, datadist),}
...
\begin{Highlighting}[]
\NormalTok{testthat}\OperatorTok{::}\KeywordTok{expect_equal}\NormalTok{(}
    \KeywordTok{sim_n}\NormalTok{(opt3_os}\OperatorTok{$}\NormalTok{design, }\FloatTok{.2}\NormalTok{, datadist),}
    \KeywordTok{evaluate}\NormalTok{(ess, opt3_os}\OperatorTok{$}\NormalTok{design),}
    \DataTypeTok{tolerance =} \FloatTok{.5}
\NormalTok{)}

\NormalTok{testthat}\OperatorTok{::}\KeywordTok{expect_equal}\NormalTok{(}
    \KeywordTok{sim_n}\NormalTok{(opt3_gs}\OperatorTok{$}\NormalTok{design, }\FloatTok{.2}\NormalTok{, datadist),}
    \KeywordTok{evaluate}\NormalTok{(ess, opt3_gs}\OperatorTok{$}\NormalTok{design),}
    \DataTypeTok{tolerance =} \FloatTok{.5}
\NormalTok{)}

\NormalTok{testthat}\OperatorTok{::}\KeywordTok{expect_equal}\NormalTok{(}
    \KeywordTok{sim_n}\NormalTok{(opt3_ts}\OperatorTok{$}\NormalTok{design, }\FloatTok{.2}\NormalTok{, datadist),}
    \KeywordTok{evaluate}\NormalTok{(ess, opt3_ts}\OperatorTok{$}\NormalTok{design),}
    \DataTypeTok{tolerance =} \FloatTok{.5}
\NormalTok{)}
\end{Highlighting}
...
\includegraphics{adoptr-validation-report_files/figure-latex/unnamed-chunk-101-1.pdf}

\hypertarget{secenario-v}{%
\chapter{Secenario V}\label{secenario-v}}
...
\hypertarget{case-v-1-sensitivity-to-integration-order}{%
\section{Case V-1, sensitivity to integration order}\label{case-v-1-sensitivity-to-integration-order}}
...
\NormalTok{init_design <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(order) \{}
    \KeywordTok{TwoStageDesign}\NormalTok{(}
        \DataTypeTok{n1 =} \KeywordTok{ceiling}\NormalTok{(pwr}\OperatorTok{::}\KeywordTok{pwr.t.test}\NormalTok{(}\DataTypeTok{d =} \FloatTok{.3}\NormalTok{, }\DataTypeTok{sig.level =} \FloatTok{.025}\NormalTok{, }\DataTypeTok{power =} \FloatTok{.8}\NormalTok{, }\DataTypeTok{alternative =} \StringTok{"greater"}\NormalTok{)}\OperatorTok{$}\NormalTok{n) }\OperatorTok{/}\StringTok{ }\DecValTok{2}\NormalTok{,}
        \DataTypeTok{c1f =} \DecValTok{0}\NormalTok{,}
        \DataTypeTok{c1e =} \KeywordTok{qnorm}\NormalTok{( }\DecValTok{1} \OperatorTok{-}\StringTok{ }\FloatTok{0.025}\NormalTok{),}
        \DataTypeTok{n2 =} \KeywordTok{ceiling}\NormalTok{(pwr}\OperatorTok{::}\KeywordTok{pwr.t.test}\NormalTok{(}\DataTypeTok{d =} \FloatTok{.3}\NormalTok{, }\DataTypeTok{sig.level =} \FloatTok{.025}\NormalTok{, }\DataTypeTok{power =} \FloatTok{.8}\NormalTok{, }\DataTypeTok{alternative =} \StringTok{"greater"}\NormalTok{)}\OperatorTok{$}\NormalTok{n) }\OperatorTok{/}\StringTok{ }\DecValTok{2}\NormalTok{,}
...
\NormalTok{tmp     <-}\StringTok{ }\KeywordTok{sapply}\NormalTok{(opt1, }\ControlFlowTok{function}\NormalTok{(x) }\KeywordTok{sim_toer}\NormalTok{(x}\OperatorTok{$}\NormalTok{design))}
\NormalTok{df_toer <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}
    \DataTypeTok{toer =} \KeywordTok{as.numeric}\NormalTok{(tmp[}\DecValTok{1}\NormalTok{, ]),}
    \DataTypeTok{se   =} \KeywordTok{as.numeric}\NormalTok{(tmp[}\DecValTok{2}\NormalTok{, ])}
\NormalTok{)}
...
\NormalTok{testthat}\OperatorTok{::}\KeywordTok{expect_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(df_toer}\OperatorTok{$}\NormalTok{toer }\OperatorTok{<}\StringTok{ }\FloatTok{.025} \OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{+}\StringTok{ }\FloatTok{.02}\NormalTok{)))}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sim_pow <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(design) \{}
\NormalTok{    simdata <-}\StringTok{ }\KeywordTok{simulate}\NormalTok{(}
\NormalTok{        design,}
        \DataTypeTok{nsim  =} \DecValTok{10}\OperatorTok{^}\DecValTok{6}\NormalTok{, }
        \DataTypeTok{dist  =}\NormalTok{ datadist, }
        \DataTypeTok{theta =}   \FloatTok{.3}\NormalTok{,}
        \DataTypeTok{seed  =} \DecValTok{42}
\NormalTok{    )}
    \KeywordTok{return}\NormalTok{(}\KeywordTok{list}\NormalTok{(}
        \DataTypeTok{pow =} \KeywordTok{mean}\NormalTok{(simdata}\OperatorTok{$}\NormalTok{reject), }
        \DataTypeTok{se  =} \KeywordTok{sd}\NormalTok{(simdata}\OperatorTok{$}\NormalTok{reject) }\OperatorTok{/}\StringTok{ }\KeywordTok{sqrt}\NormalTok{(}\KeywordTok{nrow}\NormalTok{(simdata))}
\NormalTok{    ))}
\NormalTok{\}}

\NormalTok{tmp     <-}\StringTok{ }\KeywordTok{sapply}\NormalTok{(opt1, }\ControlFlowTok{function}\NormalTok{(x) }\KeywordTok{sim_pow}\NormalTok{(x}\OperatorTok{$}\NormalTok{design))}
\NormalTok{df_pow <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}
...
\NormalTok{testthat}\OperatorTok{::}\KeywordTok{expect_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(df_pow}\OperatorTok{$}\NormalTok{pow }\OperatorTok{>}\StringTok{ }\FloatTok{0.8} \OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{-}\StringTok{ }\FloatTok{.02}\NormalTok{)))}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sim_ess <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(design) \{}
\NormalTok{    simdata <-}\StringTok{ }\KeywordTok{simulate}\NormalTok{(}
\NormalTok{        design,}
        \DataTypeTok{nsim  =} \DecValTok{10}\OperatorTok{^}\DecValTok{6}\NormalTok{, }
        \DataTypeTok{dist  =}\NormalTok{ datadist, }
...
\NormalTok{    )}
    \KeywordTok{return}\NormalTok{(}\KeywordTok{list}\NormalTok{(}
        \DataTypeTok{n  =} \KeywordTok{mean}\NormalTok{(simdata}\OperatorTok{$}\NormalTok{n1 }\OperatorTok{+}\StringTok{ }\NormalTok{simdata}\OperatorTok{$}\NormalTok{n2), }
        \DataTypeTok{se =} \KeywordTok{sd}\NormalTok{(simdata}\OperatorTok{$}\NormalTok{n1 }\OperatorTok{+}\StringTok{ }\NormalTok{simdata}\OperatorTok{$}\NormalTok{n2) }\OperatorTok{/}\StringTok{ }\KeywordTok{sqrt}\NormalTok{(}\KeywordTok{nrow}\NormalTok{(simdata))}
\NormalTok{    ))}
\NormalTok{\}}

\NormalTok{tmp     <-}\StringTok{ }\KeywordTok{sapply}\NormalTok{(opt1, }\ControlFlowTok{function}\NormalTok{(x) }\KeywordTok{sim_ess}\NormalTok{(x}\OperatorTok{$}\NormalTok{design))}
...
## 3 70.99167 0.02437997
\end{verbatim}

\hypertarget{case-v-2-utility-maximization}{%
\section{Case V-2, utility maximization}\label{case-v-2-utility-maximization}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tmp     <-}\StringTok{ }\KeywordTok{sapply}\NormalTok{(opt2, }\ControlFlowTok{function}\NormalTok{(x) }\KeywordTok{sim_toer}\NormalTok{(x}\OperatorTok{$}\NormalTok{design))}
\NormalTok{df_toer <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}
    \DataTypeTok{toer =} \KeywordTok{as.numeric}\NormalTok{(tmp[}\DecValTok{1}\NormalTok{, ]),}
    \DataTypeTok{se   =} \KeywordTok{as.numeric}\NormalTok{(tmp[}\DecValTok{2}\NormalTok{, ])}
\NormalTok{)}
...
\includegraphics{adoptr-validation-report_files/figure-latex/unnamed-chunk-118-1.pdf}

\hypertarget{case-v-3-n1-penalty}{%
\section{Case V-3, n1-penalty}\label{case-v-3-n1-penalty}}
...
\includegraphics{adoptr-validation-report_files/figure-latex/unnamed-chunk-123-1.pdf}

\hypertarget{case-v-4-n2-penalty}{%
\section{Case V-4, n2-penalty}\label{case-v-4-n2-penalty}}
...
\includegraphics{adoptr-validation-report_files/figure-latex/unnamed-chunk-128-1.pdf}
