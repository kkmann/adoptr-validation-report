...
\NormalTok{seed  \textless{}{-}}\StringTok{ }\DecValTok{42}

\CommentTok{\# define absolute tolerance for error rates}
\NormalTok{tol   \textless{}{-}}\StringTok{ }\FloatTok{0.01}

\CommentTok{\# define absolute tolerance for sample sizes}
\NormalTok{tol\_n \textless{}{-}}\StringTok{ }\FloatTok{0.5}

\CommentTok{\# define custom tolerance and iteration limit for nloptr}
\NormalTok{opts =}\StringTok{ }\KeywordTok{list}\NormalTok{(}
    \DataTypeTok{algorithm =} \StringTok{"NLOPT\_LN\_COBYLA"}\NormalTok{,}
    \DataTypeTok{xtol\_rel  =} \FloatTok{1e{-}5}\NormalTok{,}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tbl\_designs }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{transmute}\NormalTok{(}
\NormalTok{      type, }
      \DataTypeTok{iterations =}\NormalTok{ purrr}\OperatorTok{::}\KeywordTok{map\_int}\NormalTok{(tbl\_designs}\OperatorTok{$}\NormalTok{optimal, }
                                  \OperatorTok{\textasciitilde{}}\NormalTok{.}\OperatorTok{$}\NormalTok{nloptr\_return}\OperatorTok{$}\NormalTok{iterations) ) }\OperatorTok{\%\textgreater{}\%}
\StringTok{  }\NormalTok{\{}\KeywordTok{print}\NormalTok{(.); .\} }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\NormalTok{\{testthat}\OperatorTok{::}\KeywordTok{expect\_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(.}\OperatorTok{$}\NormalTok{iterations }\OperatorTok{\textless{}}\StringTok{ }\NormalTok{opts}\OperatorTok{$}\NormalTok{maxeval))\}}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{transmute}\NormalTok{(}
\NormalTok{      type, }
      \DataTypeTok{toer  =}\NormalTok{ purrr}\OperatorTok{::}\KeywordTok{map}\NormalTok{(tbl\_designs}\OperatorTok{$}\NormalTok{optimal, }
                         \OperatorTok{\textasciitilde{}}\KeywordTok{sim\_pr\_reject}\NormalTok{(.[[}\DecValTok{1}\NormalTok{]], }\FloatTok{.0}\NormalTok{, datadist)}\OperatorTok{$}\NormalTok{prob), }
      \DataTypeTok{power =}\NormalTok{ purrr}\OperatorTok{::}\KeywordTok{map}\NormalTok{(tbl\_designs}\OperatorTok{$}\NormalTok{optimal, }
                         \OperatorTok{\textasciitilde{}}\KeywordTok{sim\_pr\_reject}\NormalTok{(.[[}\DecValTok{1}\NormalTok{]], }\FloatTok{.4}\NormalTok{, datadist)}\OperatorTok{$}\NormalTok{prob) ) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{unnest}\NormalTok{(., }\DataTypeTok{cols =} \KeywordTok{c}\NormalTok{(toer, power)) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\NormalTok{\{}\KeywordTok{print}\NormalTok{(.); .\} }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\NormalTok{\{}
\NormalTok{  testthat}\OperatorTok{::}\KeywordTok{expect\_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(.}\OperatorTok{$}\NormalTok{toer  }\OperatorTok{\textless{}=}\StringTok{ }\NormalTok{alpha }\OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{+}\StringTok{ }\NormalTok{tol)))}
\NormalTok{  testthat}\OperatorTok{::}\KeywordTok{expect\_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(.}\OperatorTok{$}\NormalTok{power }\OperatorTok{\textgreater{}=}\StringTok{ }\NormalTok{min\_power }\OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{{-}}\StringTok{ }\NormalTok{tol))) \}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{expect\_true}\NormalTok{(}
    \KeywordTok{all}\NormalTok{(}\KeywordTok{diff}\NormalTok{(}
        \CommentTok{\# get optimal two{-}stage design n2 pivots}
\NormalTok{        tbl\_designs }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\KeywordTok{filter}\NormalTok{(type }\OperatorTok{==}\StringTok{ "two{-}stage"}\NormalTok{) }\OperatorTok{\%\textgreater{}\%}
\StringTok{           }\NormalTok{\{.[[}\StringTok{"optimal"}\NormalTok{]][[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{design}\OperatorTok{@}\NormalTok{n2\_pivots\} }
\NormalTok{        ) }\OperatorTok{\textless{}}\StringTok{ }\DecValTok{0}\NormalTok{) )}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ess0 \textless{}{-}}\StringTok{ }\KeywordTok{ExpectedSampleSize}\NormalTok{(datadist, H\_}\DecValTok{0}\NormalTok{)}

\NormalTok{tbl\_designs }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}
        \DataTypeTok{ess      =} \KeywordTok{map\_dbl}\NormalTok{(optimal,}
                           \OperatorTok{\textasciitilde{}}\KeywordTok{evaluate}\NormalTok{(ess, .}\OperatorTok{$}\NormalTok{design) ),}
        \DataTypeTok{ess\_sim  =} \KeywordTok{map\_dbl}\NormalTok{(optimal,}
                           \OperatorTok{\textasciitilde{}}\KeywordTok{sim\_n}\NormalTok{(.}\OperatorTok{$}\NormalTok{design, }\FloatTok{.4}\NormalTok{, datadist)}\OperatorTok{$}\NormalTok{n ),}
        \DataTypeTok{ess0     =} \KeywordTok{map\_dbl}\NormalTok{(optimal,}
                           \OperatorTok{\textasciitilde{}}\KeywordTok{evaluate}\NormalTok{(ess0, .}\OperatorTok{$}\NormalTok{design) ),}
        \DataTypeTok{ess0\_sim =} \KeywordTok{map\_dbl}\NormalTok{(optimal,}
                           \OperatorTok{\textasciitilde{}}\KeywordTok{sim\_n}\NormalTok{(.}\OperatorTok{$}\NormalTok{design, }\FloatTok{.0}\NormalTok{, datadist)}\OperatorTok{$}\NormalTok{n ) ) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{    }\NormalTok{\{}\KeywordTok{print}\NormalTok{(.); .\} }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\NormalTok{\{}
    \CommentTok{\# sim/evaluate same under alternative?}
\NormalTok{    testthat}\OperatorTok{::}\KeywordTok{expect\_equal}\NormalTok{(.}\OperatorTok{$}\NormalTok{ess, .}\OperatorTok{$}\NormalTok{ess\_sim, }
                           \DataTypeTok{tolerance =}\NormalTok{ tol\_n,}
                           \DataTypeTok{scale =} \DecValTok{1}\NormalTok{)}
    \CommentTok{\# sim/evaluate same under null?}
\NormalTok{    testthat}\OperatorTok{::}\KeywordTok{expect\_equal}\NormalTok{(.}\OperatorTok{$}\NormalTok{ess0, .}\OperatorTok{$}\NormalTok{ess0\_sim, }
                           \DataTypeTok{tolerance =}\NormalTok{ tol\_n,}
                           \DataTypeTok{scale =} \DecValTok{1}\NormalTok{)}
    \CommentTok{\# monotonicity with respect to degrees of freedom}
\NormalTok{    testthat}\OperatorTok{::}\KeywordTok{expect\_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(}\KeywordTok{diff}\NormalTok{(.}\OperatorTok{$}\NormalTok{ess) }\OperatorTok{\textless{}}\StringTok{ }\DecValTok{0}\NormalTok{)) \}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{testthat}\OperatorTok{::}\KeywordTok{expect\_lte}\NormalTok{(}
  \KeywordTok{evaluate}\NormalTok{(ess, }
\NormalTok{             tbl\_designs }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{                }\KeywordTok{filter}\NormalTok{(type }\OperatorTok{==}\StringTok{ "group{-}sequential"}\NormalTok{) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{                }\KeywordTok{pull}\NormalTok{(optimal) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{                }\NormalTok{.[[}\DecValTok{1}\NormalTok{]]  }\OperatorTok{\%\textgreater{}\%}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{opt\_h0}\OperatorTok{$}\NormalTok{nloptr\_return}\OperatorTok{$}\NormalTok{iterations }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{    }\NormalTok{\{}\KeywordTok{print}\NormalTok{(.); .\} }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{    }\NormalTok{\{testthat}\OperatorTok{::}\KeywordTok{expect\_true}\NormalTok{(. }\OperatorTok{\textless{}}\StringTok{ }\NormalTok{opts}\OperatorTok{$}\NormalTok{maxeval)\}}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\KeywordTok{expect\_true}\NormalTok{(}
    \KeywordTok{all}\NormalTok{(}\KeywordTok{diff}\NormalTok{(opt\_h0}\OperatorTok{$}\NormalTok{design}\OperatorTok{@}\NormalTok{n2\_pivots) }\OperatorTok{\textgreater{}}\StringTok{ }\DecValTok{0}\NormalTok{) )}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tbl\_performance \textless{}{-}}\StringTok{ }\KeywordTok{tibble}\NormalTok{(}
    \DataTypeTok{delta =} \KeywordTok{c}\NormalTok{(.}\DecValTok{0}\NormalTok{, }\FloatTok{.4}\NormalTok{) ) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}
        \DataTypeTok{power     =} \KeywordTok{map}\NormalTok{(}
\NormalTok{            delta, }
            \OperatorTok{\textasciitilde{}}\KeywordTok{evaluate}\NormalTok{(}
                \KeywordTok{Power}\NormalTok{(datadist, }\KeywordTok{PointMassPrior}\NormalTok{(., }\DecValTok{1}\NormalTok{)), }
\NormalTok{                opt\_h0}\OperatorTok{$}\NormalTok{design) ),}
        \DataTypeTok{power\_sim =} \KeywordTok{map}\NormalTok{(}
\NormalTok{            delta, }
            \OperatorTok{\textasciitilde{}}\KeywordTok{sim\_pr\_reject}\NormalTok{(opt\_h0}\OperatorTok{$}\NormalTok{design, ., datadist)}\OperatorTok{$}\NormalTok{prob),}
        \DataTypeTok{ess       =} \KeywordTok{map}\NormalTok{(}
\NormalTok{            delta, }
            \OperatorTok{\textasciitilde{}}\KeywordTok{evaluate}\NormalTok{(}\KeywordTok{ExpectedSampleSize}\NormalTok{(}
\NormalTok{                    datadist, }
                    \KeywordTok{PointMassPrior}\NormalTok{(., }\DecValTok{1}\NormalTok{) ), }
\NormalTok{                opt\_h0}\OperatorTok{$}\NormalTok{design) ),}
        \DataTypeTok{ess\_sim   =} \KeywordTok{map}\NormalTok{(}
\NormalTok{            delta, }
            \OperatorTok{\textasciitilde{}}\KeywordTok{sim\_n}\NormalTok{(opt\_h0}\OperatorTok{$}\NormalTok{design, . ,datadist)}\OperatorTok{$}\NormalTok{n ) ) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{    }\KeywordTok{unnest}\NormalTok{(., }\DataTypeTok{cols =} \KeywordTok{c}\NormalTok{(power, power\_sim, ess, ess\_sim))}

\KeywordTok{print}\NormalTok{(tbl\_performance)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{testthat}\OperatorTok{::}\KeywordTok{expect\_lte}\NormalTok{(}
\NormalTok{    tbl\_performance }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\KeywordTok{filter}\NormalTok{(delta }\OperatorTok{==}\StringTok{ }\DecValTok{0}\NormalTok{) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\KeywordTok{pull}\NormalTok{(power\_sim),}
\NormalTok{    alpha }\OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{+}\StringTok{ }\NormalTok{tol) )}

\NormalTok{testthat}\OperatorTok{::}\KeywordTok{expect\_gte}\NormalTok{(}
\NormalTok{    tbl\_performance }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\KeywordTok{filter}\NormalTok{(delta }\OperatorTok{==}\StringTok{ }\FloatTok{0.4}\NormalTok{) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\KeywordTok{pull}\NormalTok{(power\_sim),}
\NormalTok{    min\_power }\OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{{-}}\StringTok{ }\NormalTok{tol) )}

\CommentTok{\# make sure that evaluate() leads to same results}
\NormalTok{testthat}\OperatorTok{::}\KeywordTok{expect\_equal}\NormalTok{(}
\NormalTok{    tbl\_performance}\OperatorTok{$}\NormalTok{power, tbl\_performance}\OperatorTok{$}\NormalTok{power\_sim, }
    \DataTypeTok{tol   =}\NormalTok{ tol,}
    \DataTypeTok{scale =} \DecValTok{1}\NormalTok{ )}

\NormalTok{testthat}\OperatorTok{::}\KeywordTok{expect\_equal}\NormalTok{(}
\NormalTok{    tbl\_performance}\OperatorTok{$}\NormalTok{ess, tbl\_performance}\OperatorTok{$}\NormalTok{ess\_sim, }
    \DataTypeTok{tol   =}\NormalTok{ tol\_n,}
    \DataTypeTok{scale =} \DecValTok{1}\NormalTok{ )}
\end{Highlighting}
\end{Shaded}
...
\StringTok{                }\KeywordTok{pull}\NormalTok{(initial) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{                }\NormalTok{.[[}\DecValTok{1}\NormalTok{]] ),}
    \KeywordTok{evaluate}\NormalTok{(ess0, opt\_h0}\OperatorTok{$}\NormalTok{design) )}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{opt\_cp}\OperatorTok{$}\NormalTok{nloptr\_return}\OperatorTok{$}\NormalTok{iterations }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{    }\NormalTok{\{}\KeywordTok{print}\NormalTok{(.); .\} }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{    }\NormalTok{\{testthat}\OperatorTok{::}\KeywordTok{expect\_true}\NormalTok{(. }\OperatorTok{\textless{}}\StringTok{ }\NormalTok{opts}\OperatorTok{$}\NormalTok{maxeval)\}}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{            delta, }
            \OperatorTok{\textasciitilde{}}\KeywordTok{evaluate}\NormalTok{(}
                \KeywordTok{Power}\NormalTok{(datadist, }\KeywordTok{PointMassPrior}\NormalTok{(., }\DecValTok{1}\NormalTok{)), }
\NormalTok{                opt\_cp}\OperatorTok{$}\NormalTok{design) ),}
        \DataTypeTok{power\_sim =} \KeywordTok{map}\NormalTok{(}
\NormalTok{            delta, }
            \OperatorTok{\textasciitilde{}}\KeywordTok{sim\_pr\_reject}\NormalTok{(opt\_cp}\OperatorTok{$}\NormalTok{design, ., datadist)}\OperatorTok{$}\NormalTok{prob),}
        \DataTypeTok{ess       =} \KeywordTok{map}\NormalTok{(}
\NormalTok{            delta, }
            \OperatorTok{\textasciitilde{}}\KeywordTok{evaluate}\NormalTok{(}\KeywordTok{ExpectedSampleSize}\NormalTok{(}
\NormalTok{                    datadist, }
...
\NormalTok{                opt\_cp}\OperatorTok{$}\NormalTok{design) ),}
        \DataTypeTok{ess\_sim   =} \KeywordTok{map}\NormalTok{(}
\NormalTok{            delta, }
            \OperatorTok{\textasciitilde{}}\KeywordTok{sim\_n}\NormalTok{(opt\_cp}\OperatorTok{$}\NormalTok{design, . ,datadist)}\OperatorTok{$}\NormalTok{n ) ) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{    }\KeywordTok{unnest}\NormalTok{(., }\DataTypeTok{cols =} \KeywordTok{c}\NormalTok{(power, power\_sim, ess, ess\_sim))}
...
\KeywordTok{tibble}\NormalTok{(}
    \DataTypeTok{x1     =} \KeywordTok{seq}\NormalTok{(opt\_cp}\OperatorTok{$}\NormalTok{design}\OperatorTok{@}\NormalTok{c1f, opt\_cp}\OperatorTok{$}\NormalTok{design}\OperatorTok{@}\NormalTok{c1e, }\DataTypeTok{length.out =} \DecValTok{25}\NormalTok{),}
    \DataTypeTok{cp     =} \KeywordTok{map\_dbl}\NormalTok{(x1, }\OperatorTok{\textasciitilde{}}\KeywordTok{evaluate}\NormalTok{(cp, opt\_cp}\OperatorTok{$}\NormalTok{design, .)),}
    \DataTypeTok{cp\_sim =} \KeywordTok{map\_dbl}\NormalTok{(x1, }\ControlFlowTok{function}\NormalTok{(x1) \{}
\NormalTok{        x2  \textless{}{-}}\StringTok{ }\KeywordTok{simulate}\NormalTok{(datadist, }\DecValTok{10}\OperatorTok{\^{}}\DecValTok{6}\NormalTok{, }\KeywordTok{n2}\NormalTok{(opt\_cp}\OperatorTok{$}\NormalTok{design, x1), }\FloatTok{.4}\NormalTok{, }\DecValTok{42}\NormalTok{)}
\NormalTok{        rej \textless{}{-}}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(x2 }\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{c2}\NormalTok{(opt\_cp}\OperatorTok{$}\NormalTok{design, x1), }\DecValTok{1}\NormalTok{, }\DecValTok{0}\NormalTok{)}
        \KeywordTok{return}\NormalTok{(}\KeywordTok{mean}\NormalTok{(rej))}
\NormalTok{    \}) ) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\NormalTok{\{}\KeywordTok{print}\NormalTok{(.); .\} }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\NormalTok{\{}
\NormalTok{      testthat}\OperatorTok{::}\KeywordTok{expect\_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(.}\OperatorTok{$}\NormalTok{cp     }\OperatorTok{\textgreater{}=}\StringTok{ }\FloatTok{0.7} \OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{{-}}\StringTok{ }\NormalTok{tol)))}
\NormalTok{      testthat}\OperatorTok{::}\KeywordTok{expect\_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(.}\OperatorTok{$}\NormalTok{cp\_sim }\OperatorTok{\textgreater{}=}\StringTok{ }\FloatTok{0.7} \OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{{-}}\StringTok{ }\NormalTok{tol))) }
\NormalTok{      testthat}\OperatorTok{::}\KeywordTok{expect\_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(}\KeywordTok{abs}\NormalTok{(.}\OperatorTok{$}\NormalTok{cp }\OperatorTok{{-}}\StringTok{ }\NormalTok{.}\OperatorTok{$}\NormalTok{cp\_sim) }\OperatorTok{\textless{}=}\StringTok{ }\NormalTok{tol)) \}}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{testthat}\OperatorTok{::}\KeywordTok{expect\_gte}\NormalTok{(}
    \KeywordTok{evaluate}\NormalTok{(ess, opt\_cp}\OperatorTok{$}\NormalTok{design),}
    \KeywordTok{evaluate}\NormalTok{(}
\NormalTok{        ess, }
\NormalTok{        tbl\_designs }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{            }\KeywordTok{filter}\NormalTok{(type }\OperatorTok{==}\StringTok{ "two{-}stage"}\NormalTok{) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{            }\KeywordTok{pull}\NormalTok{(optimal) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{            }\NormalTok{.[[}\DecValTok{1}\NormalTok{]] }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{            }\NormalTok{.}\OperatorTok{$}\NormalTok{design ) )}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{      type, }
      \DataTypeTok{toer =}\NormalTok{ purrr}\OperatorTok{::}\KeywordTok{map}\NormalTok{(tbl\_designs}\OperatorTok{$}\NormalTok{optimal, }
                        \OperatorTok{\textasciitilde{}}\KeywordTok{sim\_pr\_reject}\NormalTok{(.[[}\DecValTok{1}\NormalTok{]], }\FloatTok{.0}\NormalTok{, datadist)}\OperatorTok{$}\NormalTok{prob) ) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{unnest}\NormalTok{(., }\DataTypeTok{cols =} \KeywordTok{c}\NormalTok{(toer)) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\NormalTok{\{}\KeywordTok{print}\NormalTok{(.); .\} }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\NormalTok{\{}
\NormalTok{  testthat}\OperatorTok{::}\KeywordTok{expect\_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(.}\OperatorTok{$}\NormalTok{toer }\OperatorTok{\textless{}=}\StringTok{ }\NormalTok{alpha }\OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{+}\StringTok{ }\NormalTok{tol))) \}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{essh0 \textless{}{-}}\StringTok{ }\KeywordTok{ExpectedSampleSize}\NormalTok{(datadist, H\_}\DecValTok{0}\NormalTok{)}

\NormalTok{tbl\_designs }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}
        \DataTypeTok{ess       =} \KeywordTok{map\_dbl}\NormalTok{(optimal,}
                            \OperatorTok{\textasciitilde{}}\KeywordTok{evaluate}\NormalTok{(ess, .}\OperatorTok{$}\NormalTok{design) ),}
        \DataTypeTok{essh0     =} \KeywordTok{map\_dbl}\NormalTok{(optimal,}
                            \OperatorTok{\textasciitilde{}}\KeywordTok{evaluate}\NormalTok{(essh0, .}\OperatorTok{$}\NormalTok{design) ),}
        \DataTypeTok{essh0\_sim =} \KeywordTok{map\_dbl}\NormalTok{(optimal,}
                            \OperatorTok{\textasciitilde{}}\KeywordTok{sim\_n}\NormalTok{(.}\OperatorTok{$}\NormalTok{design, }\FloatTok{.0}\NormalTok{, datadist)}\OperatorTok{$}\NormalTok{n ) ) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{    }\NormalTok{\{}\KeywordTok{print}\NormalTok{(.); .\} }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\NormalTok{\{}
    \CommentTok{\# sim/evaluate same under null?}
\NormalTok{    testthat}\OperatorTok{::}\KeywordTok{expect\_equal}\NormalTok{(.}\OperatorTok{$}\NormalTok{essh0, .}\OperatorTok{$}\NormalTok{essh0\_sim, }
                           \DataTypeTok{tolerance =}\NormalTok{ tol\_n,}
                           \DataTypeTok{scale =} \DecValTok{1}\NormalTok{)}
    \CommentTok{\# monotonicity with respect to degrees of freedom}
\NormalTok{    testthat}\OperatorTok{::}\KeywordTok{expect\_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(}\KeywordTok{diff}\NormalTok{(.}\OperatorTok{$}\NormalTok{ess) }\OperatorTok{\textless{}}\StringTok{ }\DecValTok{0}\NormalTok{)) \}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{testthat}\OperatorTok{::}\KeywordTok{expect\_true}\NormalTok{(opt\_neg}\OperatorTok{$}\NormalTok{nloptr\_return}\OperatorTok{$}\NormalTok{iterations }\OperatorTok{\textless{}}\StringTok{ }\NormalTok{opts}\OperatorTok{$}\NormalTok{maxeval)}
\KeywordTok{print}\NormalTok{(opt\_neg}\OperatorTok{$}\NormalTok{nloptr\_return}\OperatorTok{$}\NormalTok{iterations)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tbl\_toer \textless{}{-}}\StringTok{ }\KeywordTok{tibble}\NormalTok{(}
  \DataTypeTok{toer     =} \KeywordTok{evaluate}\NormalTok{(}\KeywordTok{Power}\NormalTok{(datadist, H\_}\DecValTok{0}\NormalTok{), opt\_neg}\OperatorTok{$}\NormalTok{design),}
  \DataTypeTok{toer\_sim =} \KeywordTok{sim\_pr\_reject}\NormalTok{(opt\_neg}\OperatorTok{$}\NormalTok{design, }\FloatTok{.0}\NormalTok{, datadist)}\OperatorTok{$}\NormalTok{prob}
\NormalTok{)}

\KeywordTok{print}\NormalTok{(tbl\_toer)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{testthat}\OperatorTok{::}\KeywordTok{expect\_true}\NormalTok{(tbl\_toer}\OperatorTok{$}\NormalTok{toer }\OperatorTok{\textless{}=}\StringTok{ }\NormalTok{alpha }\OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{+}\StringTok{ }\NormalTok{tol))}
\NormalTok{testthat}\OperatorTok{::}\KeywordTok{expect\_true}\NormalTok{(tbl\_toer}\OperatorTok{$}\NormalTok{toer\_sim }\OperatorTok{\textless{}=}\StringTok{ }\NormalTok{alpha }\OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{+}\StringTok{ }\NormalTok{tol))}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{testthat}\OperatorTok{::}\KeywordTok{expect\_lte}\NormalTok{(}
    \KeywordTok{evaluate}\NormalTok{(ess\_}\DecValTok{0}\NormalTok{, opt\_neg}\OperatorTok{$}\NormalTok{design),}
    \KeywordTok{evaluate}\NormalTok{(}
\NormalTok{        ess\_}\DecValTok{0}\NormalTok{, }
\NormalTok{        tbl\_designs }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{            }\KeywordTok{filter}\NormalTok{(type }\OperatorTok{==}\StringTok{ "two{-}stage"}\NormalTok{) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
...
\NormalTok{            cp\_cnstr}
\NormalTok{        ),}
        \DataTypeTok{initial\_design =}\NormalTok{ tbl\_designs}\OperatorTok{$}\NormalTok{initial[[}\DecValTok{3}\NormalTok{]],}
        \DataTypeTok{opts =}\NormalTok{ opts}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{print}\NormalTok{(opt\_cp}\OperatorTok{$}\NormalTok{nloptr\_return}\OperatorTok{$}\NormalTok{iterations)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{testthat}\OperatorTok{::}\KeywordTok{expect\_true}\NormalTok{(opt\_cp}\OperatorTok{$}\NormalTok{nloptr\_return}\OperatorTok{$}\NormalTok{iterations }\OperatorTok{\textless{}}\StringTok{ }\NormalTok{opts}\OperatorTok{$}\NormalTok{maxeval)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{tbl\_toer \textless{}{-}}\StringTok{ }\KeywordTok{tibble}\NormalTok{(}
  \DataTypeTok{toer     =} \KeywordTok{evaluate}\NormalTok{(}\KeywordTok{Power}\NormalTok{(datadist, H\_}\DecValTok{0}\NormalTok{), opt\_cp}\OperatorTok{$}\NormalTok{design),}
  \DataTypeTok{toer\_sim =} \KeywordTok{sim\_pr\_reject}\NormalTok{(opt\_cp}\OperatorTok{$}\NormalTok{design, }\FloatTok{.0}\NormalTok{, datadist)}\OperatorTok{$}\NormalTok{prob}
\NormalTok{)}
...
\KeywordTok{tibble}\NormalTok{(}
    \DataTypeTok{x1 =} \KeywordTok{seq}\NormalTok{(opt\_cp}\OperatorTok{$}\NormalTok{design}\OperatorTok{@}\NormalTok{c1f, opt\_cp}\OperatorTok{$}\NormalTok{design}\OperatorTok{@}\NormalTok{c1e, }\DataTypeTok{length.out =} \DecValTok{25}\NormalTok{),}
    \DataTypeTok{cp =} \KeywordTok{map\_dbl}\NormalTok{(x1, }\OperatorTok{\textasciitilde{}}\KeywordTok{evaluate}\NormalTok{(cp, opt\_cp}\OperatorTok{$}\NormalTok{design, .)) ) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\NormalTok{\{}\KeywordTok{print}\NormalTok{(.); .\} }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\NormalTok{\{}
\NormalTok{      testthat}\OperatorTok{::}\KeywordTok{expect\_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(.}\OperatorTok{$}\NormalTok{cp }\OperatorTok{\textgreater{}=}\StringTok{ }\FloatTok{0.7} \OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{{-}}\StringTok{ }\NormalTok{tol))) \}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{iters \textless{}{-}}\StringTok{ }\KeywordTok{sapply}\NormalTok{(results, }\ControlFlowTok{function}\NormalTok{(x) x}\OperatorTok{$}\NormalTok{nloptr\_return}\OperatorTok{$}\NormalTok{iterations)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{testthat}\OperatorTok{::}\KeywordTok{expect\_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(iters }\OperatorTok{\textless{}=}\StringTok{ }\NormalTok{opts}\OperatorTok{$}\NormalTok{maxeval))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{df\_toer \textless{}{-}}\StringTok{ }\KeywordTok{tibble}\NormalTok{(}
  \DataTypeTok{delta    =}\NormalTok{ deltas,}
  \DataTypeTok{toer     =} \KeywordTok{sapply}\NormalTok{(results, }\ControlFlowTok{function}\NormalTok{(x) }\KeywordTok{evaluate}\NormalTok{(}\KeywordTok{Power}\NormalTok{(datadist, H\_}\DecValTok{0}\NormalTok{), x}\OperatorTok{$}\NormalTok{design)),}
  \DataTypeTok{toer\_sim =} \KeywordTok{sapply}\NormalTok{(results, }\ControlFlowTok{function}\NormalTok{(x) }\KeywordTok{sim\_pr\_reject}\NormalTok{(x}\OperatorTok{$}\NormalTok{design, }\FloatTok{.0}\NormalTok{, datadist)}\OperatorTok{$}\NormalTok{prob)}
\NormalTok{)}

\NormalTok{testthat}\OperatorTok{::}\KeywordTok{expect\_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(df\_toer}\OperatorTok{$}\NormalTok{toer     }\OperatorTok{\textless{}=}\StringTok{ }\NormalTok{alpha }\OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{+}\StringTok{ }\NormalTok{tol)))}
\NormalTok{testthat}\OperatorTok{::}\KeywordTok{expect\_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(df\_toer}\OperatorTok{$}\NormalTok{toer\_sim }\OperatorTok{\textless{}=}\StringTok{ }\NormalTok{alpha }\OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{+}\StringTok{ }\NormalTok{tol)))}

\KeywordTok{print}\NormalTok{(df\_toer)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{      type, }
      \DataTypeTok{toer  =}\NormalTok{ purrr}\OperatorTok{::}\KeywordTok{map}\NormalTok{(tbl\_designs}\OperatorTok{$}\NormalTok{optimal, }
                         \OperatorTok{\textasciitilde{}}\KeywordTok{sim\_pr\_reject}\NormalTok{(.[[}\DecValTok{1}\NormalTok{]], }\FloatTok{.0}\NormalTok{, datadist)}\OperatorTok{$}\NormalTok{prob), }
      \DataTypeTok{power =}\NormalTok{ purrr}\OperatorTok{::}\KeywordTok{map}\NormalTok{(tbl\_designs}\OperatorTok{$}\NormalTok{optimal, }
                         \OperatorTok{\textasciitilde{}}\KeywordTok{sim\_pr\_reject}\NormalTok{(.[[}\DecValTok{1}\NormalTok{]], }\FloatTok{.2}\NormalTok{, datadist)}\OperatorTok{$}\NormalTok{prob) ) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{unnest}\NormalTok{(., }\DataTypeTok{cols =} \KeywordTok{c}\NormalTok{(toer, power)) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\NormalTok{\{}\KeywordTok{print}\NormalTok{(.); .\} }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\NormalTok{\{}
\NormalTok{  testthat}\OperatorTok{::}\KeywordTok{expect\_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(.}\OperatorTok{$}\NormalTok{toer  }\OperatorTok{\textless{}=}\StringTok{ }\NormalTok{alpha }\OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{+}\StringTok{ }\NormalTok{tol)))}
\NormalTok{  testthat}\OperatorTok{::}\KeywordTok{expect\_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(.}\OperatorTok{$}\NormalTok{power }\OperatorTok{\textgreater{}=}\StringTok{ }\NormalTok{min\_power }\OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{{-}}\StringTok{ }\NormalTok{tol))) \}}
...
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}
        \DataTypeTok{ess      =} \KeywordTok{map\_dbl}\NormalTok{(optimal,}
                           \OperatorTok{\textasciitilde{}}\KeywordTok{evaluate}\NormalTok{(ess, .}\OperatorTok{$}\NormalTok{design) ),}
        \DataTypeTok{ess\_sim  =} \KeywordTok{map\_dbl}\NormalTok{(optimal,}
                           \OperatorTok{\textasciitilde{}}\KeywordTok{sim\_n}\NormalTok{(.}\OperatorTok{$}\NormalTok{design, }\FloatTok{.2}\NormalTok{, datadist)}\OperatorTok{$}\NormalTok{n ) ) }\OperatorTok{\%\textgreater{}\%}
\StringTok{    }\NormalTok{\{}\KeywordTok{print}\NormalTok{(.); .\} }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\NormalTok{\{}
    \CommentTok{\# sim/evaluate same under alternative?}
\NormalTok{    testthat}\OperatorTok{::}\KeywordTok{expect\_equal}\NormalTok{(.}\OperatorTok{$}\NormalTok{ess, .}\OperatorTok{$}\NormalTok{ess\_sim, }
                           \DataTypeTok{tolerance =}\NormalTok{ tol\_n,}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tbl\_designs }\OperatorTok{\%\textgreater{}\%}
\StringTok{             }\KeywordTok{filter}\NormalTok{(type }\OperatorTok{==}\StringTok{ "group{-}sequential"}\NormalTok{) }\OperatorTok{\%\textgreater{}\%}
\StringTok{             }\NormalTok{\{ }\KeywordTok{expect\_lte}\NormalTok{(}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tbl\_designs\_}\DecValTok{9} \OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{transmute}\NormalTok{(}
\NormalTok{      type, }
      \DataTypeTok{iterations =}\NormalTok{ purrr}\OperatorTok{::}\KeywordTok{map\_int}\NormalTok{(tbl\_designs\_}\DecValTok{9}\OperatorTok{$}\NormalTok{optimal, }
                                  \OperatorTok{\textasciitilde{}}\NormalTok{.}\OperatorTok{$}\NormalTok{nloptr\_return}\OperatorTok{$}\NormalTok{iterations) ) }\OperatorTok{\%\textgreater{}\%}
\StringTok{  }\NormalTok{\{}\KeywordTok{print}\NormalTok{(.); .\} }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\NormalTok{\{testthat}\OperatorTok{::}\KeywordTok{expect\_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(.}\OperatorTok{$}\NormalTok{iterations }\OperatorTok{\textless{}}\StringTok{ }\NormalTok{opts}\OperatorTok{$}\NormalTok{maxeval))\}}
\end{Highlighting}
...
\StringTok{  }\KeywordTok{transmute}\NormalTok{(}
\NormalTok{      type, }
      \DataTypeTok{toer  =}\NormalTok{ purrr}\OperatorTok{::}\KeywordTok{map}\NormalTok{(tbl\_designs\_}\DecValTok{9}\OperatorTok{$}\NormalTok{optimal, }
                         \OperatorTok{\textasciitilde{}}\KeywordTok{sim\_pr\_reject}\NormalTok{(.[[}\DecValTok{1}\NormalTok{]], }\FloatTok{.0}\NormalTok{, datadist)}\OperatorTok{$}\NormalTok{prob), }
      \DataTypeTok{power =}\NormalTok{ purrr}\OperatorTok{::}\KeywordTok{map}\NormalTok{(tbl\_designs\_}\DecValTok{9}\OperatorTok{$}\NormalTok{optimal, }
                         \OperatorTok{\textasciitilde{}}\KeywordTok{sim\_pr\_reject}\NormalTok{(.[[}\DecValTok{1}\NormalTok{]], }\FloatTok{.2}\NormalTok{, datadist)}\OperatorTok{$}\NormalTok{prob) ) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{unnest}\NormalTok{(., }\DataTypeTok{cols =} \KeywordTok{c}\NormalTok{(toer, power)) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\NormalTok{\{}\KeywordTok{print}\NormalTok{(.); .\} }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\NormalTok{\{}
\NormalTok{  testthat}\OperatorTok{::}\KeywordTok{expect\_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(.}\OperatorTok{$}\NormalTok{toer  }\OperatorTok{\textless{}=}\StringTok{ }\NormalTok{alpha }\OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{+}\StringTok{ }\NormalTok{tol)))}
\NormalTok{  testthat}\OperatorTok{::}\KeywordTok{expect\_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(.}\OperatorTok{$}\NormalTok{power }\OperatorTok{\textgreater{}=}\StringTok{ }\NormalTok{min\_power\_}\DecValTok{2} \OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{{-}}\StringTok{ }\NormalTok{tol))) \}}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{    testthat}\OperatorTok{::}\KeywordTok{expect\_equal}\NormalTok{(.}\OperatorTok{$}\NormalTok{ess, .}\OperatorTok{$}\NormalTok{ess\_sim, }
    ...
    \CommentTok{\# monotonicity with respect to degrees of freedom}
\NormalTok{    testthat}\OperatorTok{::}\KeywordTok{expect\_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(}\KeywordTok{diff}\NormalTok{(.}\OperatorTok{$}\NormalTok{ess)     }\OperatorTok{\textless{}}\StringTok{ }\DecValTok{0}\NormalTok{)) }
\NormalTok{    testthat}\OperatorTok{::}\KeywordTok{expect\_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(}\KeywordTok{diff}\NormalTok{(.}\OperatorTok{$}\NormalTok{ess\_sim) }\OperatorTok{\textless{}}\StringTok{ }\DecValTok{0}\NormalTok{))\}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tbl\_designs\_}\DecValTok{9} \OperatorTok{\%\textgreater{}\%}
\StringTok{             }\KeywordTok{filter}\NormalTok{(type }\OperatorTok{==}\StringTok{ "group{-}sequential"}\NormalTok{) }\OperatorTok{\%\textgreater{}\%}
\StringTok{             }\NormalTok{\{ }\KeywordTok{expect\_lte}\NormalTok{(}
                 \KeywordTok{evaluate}\NormalTok{(ess, \{.[[}\StringTok{"optimal"}\NormalTok{]][[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{design\}),}
                 \KeywordTok{evaluate}\NormalTok{(ess, \{.[[}\StringTok{"initial"}\NormalTok{]][[}\DecValTok{1}\NormalTok{]]\})}
...
\KeywordTok{expect\_true}\NormalTok{(}
    \KeywordTok{all}\NormalTok{(}\KeywordTok{diff}\NormalTok{(}
        \CommentTok{\# get optimal two{-}stage design n2 pivots}
\NormalTok{        tbl\_designs\_}\DecValTok{9} \OperatorTok{\%\textgreater{}\%}\StringTok{ }\KeywordTok{filter}\NormalTok{(type }\OperatorTok{==}\StringTok{ "two{-}stage"}\NormalTok{) }\OperatorTok{\%\textgreater{}\%}
\StringTok{           }\NormalTok{\{.[[}\StringTok{"optimal"}\NormalTok{]][[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{design}\OperatorTok{@}\NormalTok{n2\_pivots\} }
\NormalTok{        ) }\OperatorTok{\textless{}}\StringTok{ }\DecValTok{0}\NormalTok{) )}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tbl\_designs\_}\DecValTok{5} \OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{transmute}\NormalTok{(}
\NormalTok{      type, }
      \DataTypeTok{iterations =}\NormalTok{ purrr}\OperatorTok{::}\KeywordTok{map\_int}\NormalTok{(tbl\_designs\_}\DecValTok{5}\OperatorTok{$}\NormalTok{optimal, }
                                  \OperatorTok{\textasciitilde{}}\NormalTok{.}\OperatorTok{$}\NormalTok{nloptr\_return}\OperatorTok{$}\NormalTok{iterations) ) }\OperatorTok{\%\textgreater{}\%}
\StringTok{  }\NormalTok{\{}\KeywordTok{print}\NormalTok{(.); .\} }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\NormalTok{\{testthat}\OperatorTok{::}\KeywordTok{expect\_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(.}\OperatorTok{$}\NormalTok{iterations }\OperatorTok{\textless{}}\StringTok{ }\NormalTok{opts}\OperatorTok{$}\NormalTok{maxeval))\}}
\end{Highlighting}
...
\StringTok{  }\KeywordTok{transmute}\NormalTok{(}
\NormalTok{      type, }
      \DataTypeTok{toer  =}\NormalTok{ purrr}\OperatorTok{::}\KeywordTok{map}\NormalTok{(tbl\_designs\_}\DecValTok{5}\OperatorTok{$}\NormalTok{optimal, }
                         \OperatorTok{\textasciitilde{}}\KeywordTok{sim\_pr\_reject}\NormalTok{(.[[}\DecValTok{1}\NormalTok{]], }\FloatTok{.0}\NormalTok{, datadist)}\OperatorTok{$}\NormalTok{prob), }
      \DataTypeTok{power =}\NormalTok{ purrr}\OperatorTok{::}\KeywordTok{map}\NormalTok{(tbl\_designs\_}\DecValTok{5}\OperatorTok{$}\NormalTok{optimal, }
                         \OperatorTok{\textasciitilde{}}\KeywordTok{sim\_pr\_reject}\NormalTok{(.[[}\DecValTok{1}\NormalTok{]], }\FloatTok{.2}\NormalTok{, datadist)}\OperatorTok{$}\NormalTok{prob) ) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{unnest}\NormalTok{(., }\DataTypeTok{cols =} \KeywordTok{c}\NormalTok{(toer, power)) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\NormalTok{\{}\KeywordTok{print}\NormalTok{(.); .\} }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\NormalTok{\{}
\NormalTok{  testthat}\OperatorTok{::}\KeywordTok{expect\_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(.}\OperatorTok{$}\NormalTok{toer  }\OperatorTok{\textless{}=}\StringTok{ }\NormalTok{alpha\_}\DecValTok{2} \OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{+}\StringTok{ }\NormalTok{tol)))}
\NormalTok{  testthat}\OperatorTok{::}\KeywordTok{expect\_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(.}\OperatorTok{$}\NormalTok{power }\OperatorTok{\textgreater{}=}\StringTok{ }\NormalTok{min\_power\_}\DecValTok{2} \OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{{-}}\StringTok{ }\NormalTok{tol))) \}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tbl\_designs\_}\DecValTok{5} \OperatorTok{\%\textgreater{}\%}
\StringTok{             }\KeywordTok{filter}\NormalTok{(type }\OperatorTok{==}\StringTok{ "group{-}sequential"}\NormalTok{) }\OperatorTok{\%\textgreater{}\%}
\StringTok{             }\NormalTok{\{ }\KeywordTok{expect\_lte}\NormalTok{(}
                 \KeywordTok{evaluate}\NormalTok{(ess, \{.[[}\StringTok{"optimal"}\NormalTok{]][[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{design\}),}
                 \KeywordTok{evaluate}\NormalTok{(ess, \{.[[}\StringTok{"initial"}\NormalTok{]][[}\DecValTok{1}\NormalTok{]]\})}
...
\KeywordTok{expect\_true}\NormalTok{(}
    \KeywordTok{all}\NormalTok{(}\KeywordTok{diff}\NormalTok{(}
        \CommentTok{\# get optimal two{-}stage design n2 pivots}
\NormalTok{        tbl\_designs\_}\DecValTok{5} \OperatorTok{\%\textgreater{}\%}\StringTok{ }\KeywordTok{filter}\NormalTok{(type }\OperatorTok{==}\StringTok{ "two{-}stage"}\NormalTok{) }\OperatorTok{\%\textgreater{}\%}
\StringTok{           }\NormalTok{\{.[[}\StringTok{"optimal"}\NormalTok{]][[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{design}\OperatorTok{@}\NormalTok{n2\_pivots\} }
\NormalTok{        ) }\OperatorTok{\textless{}}\StringTok{ }\DecValTok{0}\NormalTok{) )}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{init\_design \textless{}{-}}\StringTok{ }\ControlFlowTok{function}\NormalTok{(order) \{}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{opt }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{transmute}\NormalTok{(}
\NormalTok{      order, }
      \DataTypeTok{iterations =}\NormalTok{ purrr}\OperatorTok{::}\KeywordTok{map\_int}\NormalTok{(opt}\OperatorTok{$}\NormalTok{design, }
                                  \OperatorTok{\textasciitilde{}}\NormalTok{.}\OperatorTok{$}\NormalTok{nloptr\_return}\OperatorTok{$}\NormalTok{iterations) ) }\OperatorTok{\%\textgreater{}\%}
\StringTok{  }\NormalTok{\{}\KeywordTok{print}\NormalTok{(.); .\} }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\NormalTok{\{testthat}\OperatorTok{::}\KeywordTok{expect\_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(.}\OperatorTok{$}\NormalTok{iterations }\OperatorTok{\textless{}}\StringTok{ }\NormalTok{opts}\OperatorTok{$}\NormalTok{maxeval))\}}
\end{Highlighting}
...
\StringTok{  }\KeywordTok{transmute}\NormalTok{(}
\NormalTok{      order, }
      \DataTypeTok{toer      =} \KeywordTok{map\_dbl}\NormalTok{(design,}
                            \OperatorTok{\textasciitilde{}}\KeywordTok{evaluate}\NormalTok{(}\KeywordTok{Power}\NormalTok{(datadist, }\KeywordTok{PointMassPrior}\NormalTok{(.}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{)), .}\OperatorTok{$}\NormalTok{design) ),}
        \DataTypeTok{toer\_sim  =} \KeywordTok{map\_dbl}\NormalTok{(opt}\OperatorTok{$}\NormalTok{design, }
                               \OperatorTok{\textasciitilde{}}\KeywordTok{sim\_pr\_reject}\NormalTok{(.[[}\DecValTok{1}\NormalTok{]], }\FloatTok{.0}\NormalTok{, datadist)}\OperatorTok{$}\NormalTok{prob), }
        \DataTypeTok{power     =} \KeywordTok{map\_dbl}\NormalTok{(design,}
                            \OperatorTok{\textasciitilde{}}\KeywordTok{evaluate}\NormalTok{(}\KeywordTok{Power}\NormalTok{(datadist, }\KeywordTok{PointMassPrior}\NormalTok{(.}\DecValTok{3}\NormalTok{, }\DecValTok{1}\NormalTok{)), .}\OperatorTok{$}\NormalTok{design) ),}
        \DataTypeTok{power\_sim =} \KeywordTok{map\_dbl}\NormalTok{(opt}\OperatorTok{$}\NormalTok{design, }
                               \OperatorTok{\textasciitilde{}}\KeywordTok{sim\_pr\_reject}\NormalTok{(.[[}\DecValTok{1}\NormalTok{]], }\FloatTok{.3}\NormalTok{, datadist)}\OperatorTok{$}\NormalTok{prob),}
        \DataTypeTok{ess       =} \KeywordTok{map\_dbl}\NormalTok{(design, }\OperatorTok{\textasciitilde{}}\KeywordTok{evaluate}\NormalTok{(ess, .}\OperatorTok{$}\NormalTok{design) ),}
        \DataTypeTok{ess\_sim   =} \KeywordTok{map\_dbl}\NormalTok{(opt}\OperatorTok{$}\NormalTok{design, }\OperatorTok{\textasciitilde{}}\KeywordTok{sim\_n}\NormalTok{(.[[}\DecValTok{1}\NormalTok{]], }\FloatTok{.3}\NormalTok{, datadist)}\OperatorTok{$}\NormalTok{n)}
\NormalTok{  ) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{unnest}\NormalTok{(., }\DataTypeTok{cols =} \KeywordTok{c}\NormalTok{(toer, toer\_sim, power, power\_sim)) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\NormalTok{\{}\KeywordTok{print}\NormalTok{(.); .\} }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\NormalTok{\{}
\NormalTok{  testthat}\OperatorTok{::}\KeywordTok{expect\_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(.}\OperatorTok{$}\NormalTok{toer      }\OperatorTok{\textless{}=}\StringTok{ }\NormalTok{alpha }\OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{+}\StringTok{ }\NormalTok{tol)))}
\NormalTok{  testthat}\OperatorTok{::}\KeywordTok{expect\_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(.}\OperatorTok{$}\NormalTok{toer\_sim  }\OperatorTok{\textless{}=}\StringTok{ }\NormalTok{alpha }\OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{+}\StringTok{ }\NormalTok{tol)))}
\NormalTok{  testthat}\OperatorTok{::}\KeywordTok{expect\_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(.}\OperatorTok{$}\NormalTok{power     }\OperatorTok{\textgreater{}=}\StringTok{ }\NormalTok{min\_power }\OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{{-}}\StringTok{ }\NormalTok{tol)))}
\NormalTok{  testthat}\OperatorTok{::}\KeywordTok{expect\_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(.}\OperatorTok{$}\NormalTok{power\_sim }\OperatorTok{\textgreater{}=}\StringTok{ }\NormalTok{min\_power }\OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{{-}}\StringTok{ }\NormalTok{tol))) \}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{opt\_utility }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{transmute}\NormalTok{(}
\NormalTok{      lambda, }
      \DataTypeTok{iterations =}\NormalTok{ purrr}\OperatorTok{::}\KeywordTok{map\_int}\NormalTok{(opt\_utility}\OperatorTok{$}\NormalTok{design, }
                                  \OperatorTok{\textasciitilde{}}\NormalTok{.}\OperatorTok{$}\NormalTok{nloptr\_return}\OperatorTok{$}\NormalTok{iterations) ) }\OperatorTok{\%\textgreater{}\%}
\StringTok{  }\NormalTok{\{}\KeywordTok{print}\NormalTok{(.); .\} }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\NormalTok{\{testthat}\OperatorTok{::}\KeywordTok{expect\_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(.}\OperatorTok{$}\NormalTok{iterations }\OperatorTok{\textless{}}\StringTok{ }\NormalTok{opts}\OperatorTok{$}\NormalTok{maxeval))\}}
\end{Highlighting}
...
\NormalTok{      lambda, }
      \DataTypeTok{toer      =} \KeywordTok{map\_dbl}\NormalTok{(design,}
                           \OperatorTok{\textasciitilde{}}\KeywordTok{evaluate}\NormalTok{(}\KeywordTok{Power}\NormalTok{(datadist, }\KeywordTok{PointMassPrior}\NormalTok{(.}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{)), .}\OperatorTok{$}\NormalTok{design) ),}
      \DataTypeTok{toer\_sim  =}\NormalTok{ purrr}\OperatorTok{::}\KeywordTok{map}\NormalTok{(opt\_utility}\OperatorTok{$}\NormalTok{design, }
                         \OperatorTok{\textasciitilde{}}\KeywordTok{sim\_pr\_reject}\NormalTok{(.[[}\DecValTok{1}\NormalTok{]], }\FloatTok{.0}\NormalTok{, datadist)}\OperatorTok{$}\NormalTok{prob), }
      \DataTypeTok{power     =} \KeywordTok{map\_dbl}\NormalTok{(design,}
                          \OperatorTok{\textasciitilde{}}\KeywordTok{evaluate}\NormalTok{(}\KeywordTok{Power}\NormalTok{(datadist, }\KeywordTok{PointMassPrior}\NormalTok{(.}\DecValTok{3}\NormalTok{, }\DecValTok{1}\NormalTok{)), .}\OperatorTok{$}\NormalTok{design) ),}
      \DataTypeTok{power\_sim =}\NormalTok{ purrr}\OperatorTok{::}\KeywordTok{map}\NormalTok{(opt\_utility}\OperatorTok{$}\NormalTok{design, }
                         \OperatorTok{\textasciitilde{}}\KeywordTok{sim\_pr\_reject}\NormalTok{(.[[}\DecValTok{1}\NormalTok{]], }\FloatTok{.3}\NormalTok{, datadist)}\OperatorTok{$}\NormalTok{prob) ) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{unnest}\NormalTok{(., }\KeywordTok{c}\NormalTok{(toer, toer\_sim, power, power\_sim)) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\NormalTok{\{}\KeywordTok{print}\NormalTok{(.); .\} }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\NormalTok{\{}
\NormalTok{  testthat}\OperatorTok{::}\KeywordTok{expect\_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(.}\OperatorTok{$}\NormalTok{toer     }\OperatorTok{\textless{}=}\StringTok{ }\NormalTok{alpha }\OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{+}\StringTok{ }\NormalTok{tol)))}
\NormalTok{  testthat}\OperatorTok{::}\KeywordTok{expect\_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(.}\OperatorTok{$}\NormalTok{toer\_sim }\OperatorTok{\textless{}=}\StringTok{ }\NormalTok{alpha }\OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{+}\StringTok{ }\NormalTok{tol)))}
\NormalTok{  testthat}\OperatorTok{::}\KeywordTok{expect\_lte}\NormalTok{(.}\OperatorTok{$}\NormalTok{power[}\DecValTok{1}\NormalTok{], .}\OperatorTok{$}\NormalTok{power[}\DecValTok{2}\NormalTok{]) \}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{opt\_n1 }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{transmute}\NormalTok{(}
\NormalTok{      lambda, }
      \DataTypeTok{iterations =}\NormalTok{ purrr}\OperatorTok{::}\KeywordTok{map\_int}\NormalTok{(opt\_n1}\OperatorTok{$}\NormalTok{design, }
                                  \OperatorTok{\textasciitilde{}}\NormalTok{.}\OperatorTok{$}\NormalTok{nloptr\_return}\OperatorTok{$}\NormalTok{iterations) ) }\OperatorTok{\%\textgreater{}\%}
\StringTok{  }\NormalTok{\{}\KeywordTok{print}\NormalTok{(.); .\} }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\NormalTok{\{testthat}\OperatorTok{::}\KeywordTok{expect\_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(.}\OperatorTok{$}\NormalTok{iterations }\OperatorTok{\textless{}}\StringTok{ }\NormalTok{opts}\OperatorTok{$}\NormalTok{maxeval))\}}
\end{Highlighting}
...
\NormalTok{      lambda, }
      \DataTypeTok{toer      =} \KeywordTok{map\_dbl}\NormalTok{(design,}
                           \OperatorTok{\textasciitilde{}}\KeywordTok{evaluate}\NormalTok{(}\KeywordTok{Power}\NormalTok{(datadist, }\KeywordTok{PointMassPrior}\NormalTok{(.}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{)), .}\OperatorTok{$}\NormalTok{design) ),}
      \DataTypeTok{toer\_sim  =}\NormalTok{ purrr}\OperatorTok{::}\KeywordTok{map}\NormalTok{(opt\_n1}\OperatorTok{$}\NormalTok{design, }
                         \OperatorTok{\textasciitilde{}}\KeywordTok{sim\_pr\_reject}\NormalTok{(.[[}\DecValTok{1}\NormalTok{]], }\FloatTok{.0}\NormalTok{, datadist)}\OperatorTok{$}\NormalTok{prob), }
      \DataTypeTok{power     =} \KeywordTok{map\_dbl}\NormalTok{(design,}
                          \OperatorTok{\textasciitilde{}}\KeywordTok{evaluate}\NormalTok{(}\KeywordTok{Power}\NormalTok{(datadist, }\KeywordTok{PointMassPrior}\NormalTok{(.}\DecValTok{3}\NormalTok{, }\DecValTok{1}\NormalTok{)), .}\OperatorTok{$}\NormalTok{design) ),}
      \DataTypeTok{power\_sim =}\NormalTok{ purrr}\OperatorTok{::}\KeywordTok{map}\NormalTok{(opt\_n1}\OperatorTok{$}\NormalTok{design, }
                         \OperatorTok{\textasciitilde{}}\KeywordTok{sim\_pr\_reject}\NormalTok{(.[[}\DecValTok{1}\NormalTok{]], }\FloatTok{.3}\NormalTok{, datadist)}\OperatorTok{$}\NormalTok{prob) ) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{unnest}\NormalTok{(., }\DataTypeTok{cols =} \KeywordTok{c}\NormalTok{(toer, toer\_sim, power, power\_sim)) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\NormalTok{\{}\KeywordTok{print}\NormalTok{(.); .\} }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\NormalTok{\{}
\NormalTok{  testthat}\OperatorTok{::}\KeywordTok{expect\_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(.}\OperatorTok{$}\NormalTok{toer      }\OperatorTok{\textless{}=}\StringTok{ }\NormalTok{alpha }\OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{+}\StringTok{ }\NormalTok{tol)))}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{opt\_n2 }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{transmute}\NormalTok{(}
\NormalTok{      lambda, }
      \DataTypeTok{iterations =}\NormalTok{ purrr}\OperatorTok{::}\KeywordTok{map\_int}\NormalTok{(opt\_n2}\OperatorTok{$}\NormalTok{design, }
                                  \OperatorTok{\textasciitilde{}}\NormalTok{.}\OperatorTok{$}\NormalTok{nloptr\_return}\OperatorTok{$}\NormalTok{iterations) ) }\OperatorTok{\%\textgreater{}\%}
\StringTok{  }\NormalTok{\{}\KeywordTok{print}\NormalTok{(.); .\} }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\NormalTok{\{testthat}\OperatorTok{::}\KeywordTok{expect\_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(.}\OperatorTok{$}\NormalTok{iterations }\OperatorTok{\textless{}}\StringTok{ }\NormalTok{opts}\OperatorTok{$}\NormalTok{maxeval))\}}
\end{Highlighting}
...
\NormalTok{      lambda, }
      \DataTypeTok{toer      =} \KeywordTok{map\_dbl}\NormalTok{(design,}
                           \OperatorTok{\textasciitilde{}}\KeywordTok{evaluate}\NormalTok{(}\KeywordTok{Power}\NormalTok{(datadist, }\KeywordTok{PointMassPrior}\NormalTok{(.}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{)), .}\OperatorTok{$}\NormalTok{design) ),}
      \DataTypeTok{toer\_sim  =}\NormalTok{ purrr}\OperatorTok{::}\KeywordTok{map}\NormalTok{(opt\_n2}\OperatorTok{$}\NormalTok{design, }
                         \OperatorTok{\textasciitilde{}}\KeywordTok{sim\_pr\_reject}\NormalTok{(.[[}\DecValTok{1}\NormalTok{]], }\FloatTok{.0}\NormalTok{, datadist)}\OperatorTok{$}\NormalTok{prob), }
      \DataTypeTok{power     =} \KeywordTok{map\_dbl}\NormalTok{(design,}
                          \OperatorTok{\textasciitilde{}}\KeywordTok{evaluate}\NormalTok{(}\KeywordTok{Power}\NormalTok{(datadist, }\KeywordTok{PointMassPrior}\NormalTok{(.}\DecValTok{3}\NormalTok{, }\DecValTok{1}\NormalTok{)), .}\OperatorTok{$}\NormalTok{design) ),}
      \DataTypeTok{power\_sim =}\NormalTok{ purrr}\OperatorTok{::}\KeywordTok{map}\NormalTok{(opt\_n2}\OperatorTok{$}\NormalTok{design, }
                         \OperatorTok{\textasciitilde{}}\KeywordTok{sim\_pr\_reject}\NormalTok{(.[[}\DecValTok{1}\NormalTok{]], }\FloatTok{.3}\NormalTok{, datadist)}\OperatorTok{$}\NormalTok{prob) ) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{unnest}\NormalTok{(., }\KeywordTok{c}\NormalTok{(toer, toer\_sim, power, power\_sim)) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\NormalTok{\{}\KeywordTok{print}\NormalTok{(.); .\} }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\NormalTok{\{}
\NormalTok{  testthat}\OperatorTok{::}\KeywordTok{expect\_true}\NormalTok{(}\KeywordTok{all}\NormalTok{(.}\OperatorTok{$}\NormalTok{toer      }\OperatorTok{\textless{}=}\StringTok{ }\NormalTok{alpha }\OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{+}\StringTok{ }\NormalTok{tol)))}
...
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}
        \DataTypeTok{ess      =} \KeywordTok{map\_dbl}\NormalTok{(optimal,}
                           \OperatorTok{\textasciitilde{}}\KeywordTok{evaluate}\NormalTok{(ess, .}\OperatorTok{$}\NormalTok{design) ),}
        \DataTypeTok{ess\_sim  =} \KeywordTok{map\_dbl}\NormalTok{(optimal,}
                           \OperatorTok{\textasciitilde{}}\KeywordTok{sim\_n}\NormalTok{(.}\OperatorTok{$}\NormalTok{design, }\FloatTok{.2}\NormalTok{, datadist)}\OperatorTok{$}\NormalTok{n ),}
        \DataTypeTok{ess0     =} \KeywordTok{map\_dbl}\NormalTok{(optimal,}
                           \OperatorTok{\textasciitilde{}}\KeywordTok{evaluate}\NormalTok{(ess0, .}\OperatorTok{$}\NormalTok{design) ),}
        \DataTypeTok{ess0\_sim =} \KeywordTok{map\_dbl}\NormalTok{(optimal,}
                           \OperatorTok{\textasciitilde{}}\KeywordTok{sim\_n}\NormalTok{(.}\OperatorTok{$}\NormalTok{design, }\FloatTok{.0}\NormalTok{, datadist)}\OperatorTok{$}\NormalTok{n ) ) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
