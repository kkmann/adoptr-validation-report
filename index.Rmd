...
A good overview on adaptive designs is given in [@Bauer2015] or much more 
detailed in the book [@Wassmer2016].
The report explores a variety of essential scenarios and both formally
tests results (wherever possible) using **testthat** [@R-testthat].
...
* **Formal tests:**
    1. Number of iterations are checked agaist default maximum to ensure proper
      convergence.
...
* **Formal tests:**
    1. Number of iterations are checked agaist default maximum to ensure proper
      convergence.
    2. Do both desings respect the type one error rate constraint (via simulation)?
...
# define relative tolerance for error rates of 1%
tol <- 0.01

# define absolute tolerance for sample sizes of 0.5
tol_n <- 0.5
