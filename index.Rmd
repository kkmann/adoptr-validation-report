...
validation of **[adoptr](https://github.com/kkmann/adoptr)** as much as 
possible.
...
Otherwise, the resources linked at https://github.com/kkmann/adoptr are a good 
starting point.
A general overview on adaptive designs is given in [@Bauer2015] or much more 
detailed in [@Wassmer2016].

**adoptr** itself already makes extensive use of unittesting to make sure that
all functions work as intended. 
Due to constraints on the build-time for an R package, the range of scenarios 
covered in the unittests of **adoptr** is rather limited though.
This report explores a variety of essential scenarios and both formally
tests results wherever possible using **testthat** [@R-testthat] and
...
It uses the respective most current CRAN version of **adoptr**.
