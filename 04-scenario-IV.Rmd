...
The main goal is to validate `adoptr`'s sensitivity with regards to 
...
tbl_designs <- tibble(
    ...
    initial = list(
        ...
        rpact_design(0.2, 0.025, 0.8, TRUE, order),
        TwoStageDesign(rpact_design(0.2, 0.025, 0.8, TRUE, order))) )
```
...
tbl_designs_9 <- tibble(
    ...
    initial = list(
        OneStageDesign(500, 2.0),
        rpact_design(0.2, 0.025, 0.9, TRUE, order),
        TwoStageDesign(rpact_design(0.2, 0.025, 0.9, TRUE, order))) )
```
...
Again, a design computed by means of the `rpact`-package to fulfill
...
tbl_designs_5 <- tibble(
    ...
    initial = list(
        OneStageDesign(500, 2.0),
        rpact_design(0.2, 0.05, 0.9, TRUE, order),
        TwoStageDesign(rpact_design(0.2, 0.05, 0.9, TRUE, order))) )
```
