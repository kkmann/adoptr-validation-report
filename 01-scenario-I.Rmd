...
Same as in (#variantI_1), i.e., expected sample size under the 
...
The same initial (generic two-stage) design as in (#variantI_1) is used.
...
be larger than in the case without the constraint (#variantI_1).
